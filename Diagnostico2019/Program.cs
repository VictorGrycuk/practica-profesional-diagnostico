...
namespace Diagnostico2019
{
    static class Program
    {
        static void Main(string[] args)
        {
            ...
            menu.AddOption(BubbleSort.SortDescending, "Bubble sort array in descending order.");
            menu.AddOption(Dates.GetMondays, "Shows the list of dates of a specific week day between two given dates.");
            menu.AddOption(Fibonacci.GetFibonacci, "Returns a Fibonacci sequence of a given length.");
            menu.AddOption(ImageValidation.Validate, "Takes two images and returns whether they are the same or not.");
